...
const AllMeat = () => {
  ...
  return (
    <>
        <HeadMetaTags
            title="мясные блюда"
            description="мясо, говядина, свинина, курица, индейка, баранина, beef, meat, recipe, meat, dishes" 
            keywords="мясо, говядина, свинина, курица, индейка, баранина, beef, meat, recipe, meat, dishes"
            content="all" 
            ogTitle="мясные блюда"
            ogDescription="мясо, говядина, свинина, курица, индейка, баранина, beef, meat, recipe, meat, dishes"
            ogImage="/public/img/openGrafPreview_1.jpg"
            twitterTitle="мясные блюда"
            twitterDescription="мясо, говядина, свинина, курица, индейка, баранина, beef, meat, recipe, meat, dishes"
