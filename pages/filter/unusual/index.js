...
const AllUnusual = () => {
  ...
  return (
    <>
        <HeadMetaTags
            title="рецепты необычных блюд"
            description="рецепты необычных праздничных блюд, recipe unusual" 
            keywords="рецепты необычных блюд, recipe unusual"
            content="all" 
            ogTitle="рецепты необычных блюд"
            ogDescription="рецепты необычных праздничных блюд, recipe unusual"
            ogImage="/public/img/openGrafPreview_1.jpg"
            twitterTitle="рецепты необычных блюд"
            twitterDescription="рецепты необычных праздничных блюд, recipe unusual"
            twitterImage="/public/img/openGrafPreview_1.jpg"
        /> 
        <Navbar/>             
        <div className='width-100-percent'>     
            <div className='headerRecipe'>  
                <h2>Рецепты необычных блюд</h2>                        
