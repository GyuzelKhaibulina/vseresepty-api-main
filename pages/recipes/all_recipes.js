  ...
  return (
    <>
        ...
        {/* <Swiper
            ...
            modules={[Autoplay, Pagination, Navigation]}
            className="mySwiper">
            <SwiperSlide><div className='slideDivText'><div><a href="/filter/maslenitsa">Ура, Масленица!</a><p><a href="/filter/festive">Провожаем зиму, встречаем весну! Готовим наши любимы блины, блинчики, блиночки!</a></p></div><img src="/gallery/maslenitsa-1.jpg" /></div></SwiperSlide>
            ...
            <SwiperSlide><div className='slideDivText'><div><a href="/filter/festive">Готовьте блины с удовольствием, пробуйте различные варианты и сохраняйте свои семейные рецепты блинов.</a><p><a href="/filter/maslenitsa"></a></p></div><img src="/gallery/maslenitsa-10.jpg" /></div></SwiperSlide>                                                                                                                                                                               
        ...
        */} 
        ...
        <Swiper
            ...
            modules={[Autoplay, Pagination, Navigation]}            
            className="mySwiper">                      
            {/* <SwiperSlide><div className='slideDivTextWhite'><div><p><a href="/filter/marinade">Наступило время сочных овощей и ароматных сладких фруктов! Цены на сезонные продукты снижаются, сохраните вкус и витамины лета на зиму!</a></p></div><img src="/gallery/zasolka-1.jpg" /></div></SwiperSlide>
            <SwiperSlide><div className='slideDivTextWhite'><div><p><a href="/filter/marinade">С любовью делаем запасы консервированных овощей, грибов, фруктов и ягод на зиму!</a></p></div><img src="/gallery/zasolka-16.jpg" /></div></SwiperSlide> */}
            ...
            {/* <SwiperSlide><div className='slideDivTextWhite'><div><p><a href="/filter/marinade">Чтобы правильно законсервировать овощи, требуется настоящее мастерство и терпение, которое по достоинству будет оценено вашими близкими!</a></p></div><img src="/gallery/zasolka-2.jpg" /></div></SwiperSlide> */}                                              
